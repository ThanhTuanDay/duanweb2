<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4 fade-in">
        <h2>Order Details <span class="text-primary">#ORD12345</span></h2>
        <div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <div class="info-item">
                                ...
                                <div><strong>Order ID:</strong> #ORD12345</div>
                            </div>
                            <div class="info-item">
                                <div class="info-icon"><i class="fas fa-calendar"></i></div>
                                <div><strong>Order Date:</strong> May 15, 2023, 2:30 PM</div>
                            </div>
                            <div class="info-item">
                                <div class="info-icon"><i class="fas fa-credit-card"></i></div>
                                <div><strong>Payment Method:</strong> Credit Card (****4567)</div>
                            </div>
                            <div class="info-item">
                        ...
                        <div class="col-md-6" id="customer-info">
                            <div class="info-item">
                                ...
                                <div id="customer-name"><strong>Customer:</strong> John Doe</div>
                            </div>
                            <div class="info-item">
                            ...
                            <div class="info-item">
                                ...
                                <div id="customer-phone"><strong>Phone:</strong> +1 (555) 123-4567</div>
                            </div>
                            <div class="info-item">
                                <div class="info-icon"><i class="fas fa-id-card"></i></div>
                                <div id="customer-id"><strong>Customer ID:</strong> CUST001</div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card mb-4 slide-in-left" style="animation-delay: 0.4s;">
                ...
                <div class="card-body">
                    <div class="bg-light p-3 rounded border">
                        ...
                        <p class="mb-0">Please leave the order at the door. Ring the doorbell upon delivery. Thank you!</p>
            ...
            <div class="card mb-4 slide-in-right" style="animation-delay: 0.1s;">
                ...
                <div class="card-body">
                    <div class="order-summary-item">
                        <span><i class="fas fa-shopping-basket text-primary me-2"></i>Subtotal</span>
                        <span>$105.00</span>
                    </div>
                    <div class="order-summary-item">
                        <span><i class="fas fa-truck text-primary me-2"></i>Shipping</span>
                        <span>$5.99</span>
                    </div>
                    <div class="order-summary-item">
                        <span><i class="fas fa-percentage text-primary me-2"></i>Tax</span>
                        <span>$9.32</span>
                    </div>
                    <div class="order-summary-item">
                        <span><i class="fas fa-tag text-primary me-2"></i>Discount</span>
                        <span>-$10.50</span>
                    </div>
                    <div class="order-summary-item">
                    ...
                    <div class="order-summary-item">
                        <span><i class="fas fa-money-bill-wave text-primary me-2"></i>Total</span>
                        <span>$114.81</span>
                    </div>
                </div>
            </div>
