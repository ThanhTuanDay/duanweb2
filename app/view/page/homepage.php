        ...
        <div class="col-md-6  ">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <a href="#food-section">
                Đặt Ngay <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="menu-container">
      <div class="filter-sidebar" id="filter-sidebar">
        <form id="filter-form">
          <div class="filter-section">
            ...
            <div class="search-box">
              ...
              <input type="text" name="search" id="search-input" placeholder="Tìm kiếm theo tên..." value="<?= isset($_GET['search']) ? htmlspecialchars($_GET['search']) : '' ?>">
            </div>
          </div>
        ...
        <div class="filter-buttons">
          <button onclick="applyFilters(event)" class="filter-btn apply-btn">Áp Dụng Lọc</button>
          <button type="button" class="filter-btn reset-btn" id="reset-filters">Đặt Lại</button>
        </div>
      </div>
      ...
      <div class="product-tabs-section">
        <div class="custom-tabs">
          <div class="custom-tabs-nav">
            ...
            <button class="custom-tab-btn" data-tab="ingredients">Thành Phần</button>
            <button class="custom-tab-btn" data-tab="nutrition">Dinh Dưỡng</button>
            <button class="custom-tab-btn" data-tab="reviews">Đánh Giá</button>
          </div>

          <div class="custom-tabs-content">
            <div class="custom-tab-pane active" id="details-tab">
              <div class="tab-content-inner">
                <p>Món đặc trưng của chúng tôi được chế biến từ những nguyên liệu tốt nhất, được lựa chọn cẩn thận để đảm bảo hương vị và chất lượng tuyệt hảo. Mỗi món ăn được làm theo yêu cầu, đảm bảo độ tươi ngon và hương vị hoàn hảo mỗi lần.</p>
                <p>Dù bạn dùng bữa tại chỗ hay mang đi, cam kết về sự xuất sắc của chúng tôi vẫn không thay đổi. Chúng tôi tự hào phục vụ những món ăn không chỉ làm no bụng mà còn làm hài lòng vị giác của bạn.</p>
                <ul class="features-list">
                  <li><i class="fas fa-check"></i> Làm từ nguyên liệu tươi</li>
                  <li><i class="fas fa-check"></i> Không chất bảo quản</li>
                  <li><i class="fas fa-check"></i> Công thức đặc biệt của đầu bếp</li>
                  <li><i class="fas fa-check"></i> Chế biến theo yêu cầu</li>
                </ul>
              </div>
            </div>
                ...
                <div class="ingredients-list">
                  <div class="ingredient-item">
                    ...
                    <div class="ingredient-details">
                      <h5>Rau Củ Tươi</h5>
                      <p>Rau củ hữu cơ, có nguồn gốc địa phương cho hương vị và dinh dưỡng tốt nhất.</p>
                    </div>
                  </div>
                  ...
                  <div class="ingredient-item">
                    ...
                    <div class="ingredient-details">
                      ...
                      <p>Protein chất lượng cao, có nguồn gốc đạo đức, mềm và đậm đà hương vị.</p>
                    </div>
                  </div>
                  ...
                  <div class="ingredient-item">
                    ...
                    <div class="ingredient-details">
                      <h5>Phô Mai Thủ Công</h5>
                      <p>Phô mai được lựa chọn đặc biệt, tạo thêm độ béo ngậy hoàn hảo.</p>
                    </div>
                  </div>
                  ...
                  <div class="ingredient-item">
                    ...
                    <div class="ingredient-details">
                      <h5>Các Loại Thảo Mộc Tươi</h5>
                      <p>Các loại thảo mộc thơm làm tăng hương vị cho mỗi món ăn.</p>
                    </div>
                  </div>
                </div>

                <div class="allergens-info">
                  <h5>Thông Tin Dị Ứng</h5>
                  <p>Chứa: Gluten, Sữa, Trứng</p>
                  <p>Có thể chứa dấu vết của các loại hạt và đậu nành.</p>
                </div>
              </div>
            </div>
              ...
              <div class="tab-content-inner">
                <div class="nutrition-facts">
                  ...
                  <div class="nutrition-table">
                    ...
                    <div class="nutrition-row">
                      <div class="nutrition-cell">Natri</div>
                    ...
                    <div class="nutrition-row sub">
                      <div class="nutrition-cell">Đường</div>
                  ...
                  <p class="nutrition-disclaimer">* Giá trị hàng ngày dựa trên chế độ ăn 2.000 calo. Giá trị hàng ngày của bạn có thể cao hơn hoặc thấp hơn tùy thuộc vào nhu cầu calo của bạn.</p>
                </div>
              </div>
            </div>
                ...
                <div class="reviews-list">
                  <div class="review-item">
                    ...
                    <div class="review-content">
                      ...
                      <div class="review-text">
                        <p>Tuyệt đối ngon! Hương vị thật tuyệt vời và khẩu phần rất vừa vặn. Chắc chắn tôi sẽ gọi món này lại trong lần tới.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="review-item">
                    ...
                    <div class="review-content">
                      ...
                      <div class="review-text">
                        <p>Hương vị và chất lượng tuyệt vời. Chắc chắn sẽ đặt lại! Dịch vụ cũng rất xuất sắc.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="review-item">
                    ...
                    <div class="review-content">
                      ...
                      <div class="review-text">
                        <p>Một trong những bữa ăn ngon nhất tôi từng có. Hương vị cân bằng hoàn hảo và mọi thứ đều tươi ngon. Rất khuyến khích!</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <form class="review-form">
                    <div class="form-group">
                      ...
                      <div class="rating-selector">
                        ...
                        <i class="far fa-star" data-far fa-star" data-rating="3"></i>
