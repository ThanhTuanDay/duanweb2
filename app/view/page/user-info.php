...
<body>
                        ...
                        <form id="personal-info-form">
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name" class="form-control" value="John" required>
                                    <div class="form-error" id="first-name-error">Please enter your first name</div>
                                </div>
                                <div class="form-group">
                                    <label for="last-name" class="form-label">Last Name</label>
                                    <input type="text" id="last-name" class="form-control" value="Doe" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="address" class="form-control" value="123 Main Street, Apt 4B, District 1, Ho Chi Minh City">
                            </div>

                            <div class="form-actions">
                                <button type="button" class="btn btn-secondary" onclick="resetPersonalInfoForm()">Cancel</button>
                    ...
                    <div id="change-password" class="profile-card">
                        ...
                        <form id="password-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="password-input-container">
                                    <input type="password" id="new-password" class="form-control" required onkeyup="checkPasswordStrength()">
                                ...
                                <div class="form-error" id="new-password-error">Password must be at least 8 characters long</div>
                            </div>
    ...
    <script>
        ...
        function resetPersonalInfoForm() {
            // In a real application, you would reset the form to the original values from the server
        ...
        function isValidPhone(phone) {
            // This is a simple validation, you can use a more complex one
