                        ...
                        <form id="personal-info-form">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <div class="form-error" id="first-name-error">Vui lòng nhập họ của bạn</div>
                                </div>
                                <div class="form-group">
                                    <label for="last-name" class="form-label">Tên</label>
                                    <input type="text" id="last-name" class="form-control"
                                        value="<?php echo htmlspecialchars($lastName); ?>" required>
                                    <div class="form-error" id="last-name-error">Vui lòng nhập tên của bạn</div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-hint">Địa chỉ email không thể thay đổi</div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-error" id="phone-error">Vui lòng nhập số điện thoại hợp lệ!</div>
                            </div>
                            <div class="form-group">
                    ...
                    <div id="change-password" class="profile-card">
                        ...
                        <form id="password-form">
                            <div class="form-group">
                                ...
                                <div class="form-error" id="current-password-error">Vui lòng nhập mật khẩu hiện tại</div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="password-strength-text" id="password-strength-text">Mức độ bảo mật</div>
                                <div class="form-error" id="new-password-error"> Mật khẩu phải có ít nhất 8 ký tự 
                                    </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-error" id="confirm-password-error">Mật khẩu không trùng khớp</div>
                            </div>

                            <div class="form-actions">
                                <button type="button" class="btn btn-secondary"
                                    onclick="resetPasswordForm()">Hủy</button>
